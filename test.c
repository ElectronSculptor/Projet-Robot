...
int main(void)
{
  ...
  while (1)
  {
	   ...
	   __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 2556); // 0°
	  HAL_Delay(1000);
	  //__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 3408); // +90°
	  //HAL_Delay(1000);
	  //__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 1703); //-90°
	  //HAL_Delay(1000);
    /* USER CODE END WHILE */
...
void SetServoPosition(TIM_HandleTypeDef *htim, uint32_t Channel, int angle)
{
  // Associer l'angle (0 à 180) au cycle du PWM (500 à 2500 microsecondes).
  pulse_length = (500 + ((angle * 2000) / 180)); // 500us to 2500us
  // 2556 = 0°
  //

  __HAL_TIM_SET_COMPARE(htim, Channel, pulse_length);
}
//Timer 3 utilisé pour la Calibration
